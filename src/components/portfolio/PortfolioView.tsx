          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <span className="text-[10px] text-text-tertiary font-mono">{activeWallet.name || 'Active Wallet'}</span>
              </div>
            </div>
            <button
              onClick={handleRefresh}
              disabled={loading}
              className={`${theme.styles.buttonIcon} p-2 rounded-lg disabled:opacity-40`}
            >
              {loading
