...
export const themes: Record<string, ThemeConfig> = {
  ...
  dark: {
    name: 'Dark',
    styles: {
      mainContainer: 'bg-surface-base border-[#8b8bff]/10',
      drawerContainer: 'bg-surface-base border-[#8b8bff]/10',
      dialogContainer: 'bg-surface-base shadow-lg border border-[#8b8bff]/10',
      panelHeader: 'border-b border-[#8b8bff]/10',
      ...
      unlockScreen: {
        ...
        particleOpacity: 1,
        cardBg: 'bg-gradient-to-br from-[#0a0a12] to-[#12121f]',
        cardBorder: 'border-[#8b8bff]/15',
        cardGlow: '',
